...
POINT_CLOUD_REGISTER_POINT_STRUCT(OusterPointXYZIRT,
    (float, x, x) (float, y, y) (float, z, z) (float, intensity, intensity)
    (uint32_t, time, t) (uint16_t, reflectivity, reflectivity)
...
public:
    ...
    bool deskewInfo()
    {
        ...
        // std::cout << "Queue: " << imuQueue.size() << std::endl; 
        // std::cout << std::fixed << "CurrStamp: " << timeScanCur << " > QFront: " << stamp2Sec(imuQueue.front().header.stamp) << std::endl;
        // std::cout << std::fixed << "EndStamp: " << timeScanEnd << " < QBack: " << stamp2Sec(imuQueue.back().header.stamp) << std::endl;
